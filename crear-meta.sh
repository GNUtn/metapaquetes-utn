...
Description: Metapaquete de ${nombre}
 ...
 .
 ${paquete} es proveido por UTNcillo para facilitar la instalacion del software necesario para cursar en la UTN. Este paquete esta mantenido por ${mantenedor}" > ${controls}/${paquete}
